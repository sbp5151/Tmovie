...
import tmovie.jld.com.tmovie.util.TimeUtil;
import tmovie.jld.com.tmovie.util.ToastUtil;
import tmovie.jld.com.tmovie.view.PlayerView;
...
public class PlayerActivity extends Activity implements PlayerView.OnChangeListener, OnClickListener, OnSeekBarChangeListener, Callback {
    ...
    private void startAD() {
        ...
        if (isVodAD) {
            ...
            Picasso.with(this).load(adPic).error(R.mipmap.load_error).into(adPicNIV);
...
//            }
    ...
    private void initView() {
        ...
        adPicNIV = (ImageView) adView.findViewById(R.id.ad_niv_pic);
